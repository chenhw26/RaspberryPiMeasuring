...
class MycnnSPPNetFront(torch.nn.Module):
  def __init__(self):
    ...
    # ori_spp.load_state_dict(torch.load("saved_small_models/cnn_spp.pt"))
...
class MycnnSPPNetFrontWithBottlenect(torch.nn.Module):
  def __init__(self, bottleneck_channel):
    ...
    self.extractor = torch.nn.Sequential(
      torch.nn.Conv2d(3, 32, kernel_size=(7,7), stride=(2,2), padding=(3,3), bias=False),
    ...
    self.bn = torch.nn.Sequential(
      torch.nn.BatchNorm2d(32),
      torch.nn.ReLU(inplace=True),
      torch.nn.Conv2d(32, bottleneck_channel, kernel_size=(2,2), stride=(2,2), padding=(1,1), bias=False),
      torch.nn.BatchNorm2d(bottleneck_channel),
      torch.nn.ReLU(inplace=True),
      torch.nn.ConvTranspose2d(bottleneck_channel, 128, kernel_size=(4,4), stride=(2,2), bias=False),
      torch.nn.BatchNorm2d(128),
      torch.nn.ReLU(inplace=True),
      torch.nn.Conv2d(128, 64, kernel_size=(2,2), stride=(1,1), bias=False),
      torch.nn.BatchNorm2d(64),
      torch.nn.ReLU(inplace=True),
      torch.nn.Conv2d(64, 64, kernel_size=(2,2), stride=(1,1), bias=False),
      torch.nn.BatchNorm2d(64),
      torch.nn.ReLU(inplace=True),
      torch.nn.Conv2d(64, 32, kernel_size=(2,2), stride=(1,1), bias=False),
